...
| http://elixircontrol.runasp.net/swagger/index.html | /api/v1/batch           | POST      | Crear un nuevo lote     | 'Content-Type: application/json' -d '{"vineyardCode": "string", "grapeVariety": "string", ...}' | JSON con datos del lote | `{"id": 0, "vineyardCode": "string", "grapeVariety": "string", ...}`   | Retorna el objeto lote creado           |
| http://elixircontrol.runasp.net/swagger/index.html | /api/v1/batch           | GET       | Obtener todos los lotes | 'accept: application/json'                                                                      | Ninguno                 | `[{"id": 0, "vineyardCode": "string", "grapeVariety": "string", ...}]` | Retorna un array de objetos lote        |
| http://elixircontrol.runasp.net/swagger/index.html | /api/v1/batch/{batchId} | DELETE    | Eliminar un lote        | 'accept: application/json'                                                                      | batchId (path)          | 204 si se eliminó correctamente, 404 si no se encontró                 | Confirma la eliminación del lote        |
| http://elixircontrol.runasp.net/swagger/index.html | /api/v1/batch/{batchId} | PUT       | Actualizar un lote      | 'Content-Type: application/json' -d '{"vineyardCode": "string", "grapeVariety": "string", ...}' | batchId (path), JSON con datos del lote | `{"id": 0, "vineyardCode": "string", "grapeVariety": "string", ...}`   | Retorna el objeto lote actualizado      |
